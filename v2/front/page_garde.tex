...
\begin{center}
  ...
  Pr. El Bouzekri El Idrissi Younès, encadrant pédagogique, ENSA Kénitra\\[0.1cm]
...
\begin{center}
  ...
  \begin{tabular}{|p{11cm}|p{4.8cm}|}
    \hline
    Pr. El Bouzekri El Idrissi Younès, Professeur de l'Enseignement Supérieur, ENSA Kénitra & \textbf{Encadrant} \\
    \hline
    Pr. Ait Lahcen Ayoub, Professeur de l'Enseignement Supérieur, ENSA Kénitra             & \textbf{Rapporteur} \\
    \hline
    Pr. Moumen Aniss, Professeur de l'Enseignement Supérieur, ENSA Kénitra                 & \textbf{Rapporteur} \\
    \hline
  \end{tabular}
\end{center}
