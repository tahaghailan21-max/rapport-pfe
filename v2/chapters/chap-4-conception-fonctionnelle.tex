...
Ce chapitre présente la modélisation du système AOS-ETL à l'aide de diagrammes UML. Il comprend un diagramme de cas d'utilisation décrivant les acteurs principaux et leurs interactions avec le système, des diagrammes de séquence détaillant les processus clés, ainsi qu'un diagramme de classes représentant les entités fondamentales et leurs relations.
...
Le langage de modélisation unifié (UML) est un langage visuel standardisé utilisé pour spécifier, visualiser, construire et documenter les systèmes logiciels. Il permet de comprendre clairement la structure et le comportement d'un système, réduisant les ambiguïtés et assurant la cohérence tout au long du projet~\cite{uml}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{uml-sequence-mapping.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{uml-sequence-postmapping.png}
...
Ce chapitre a présenté la conception fonctionnelle du système à travers les diagrammes UML. Les cas d'utilisation ont permis d'identifier les interactions entre le responsable d'intégration et le système, les diagrammes de séquence ont détaillé les flux principaux, et le diagramme de classes a formalisé les entités clés du framework. Le chapitre suivant aborde l'architecture technique de la solution.
