...
Ce chapitre a pour but de faire la modélisation du framework d'import à partir de diagrammes UML. On y trouve un diagramme de cas d'utilisation précisant les acteurs principaux et leurs interactions avec le système, des diagrammes de séquence relatant les processus clés, un diagramme de classes destiné à représenter les entités fondamentales et leurs relations.
...
Le diagramme de cas d'utilisation ci-dessous présente les acteurs du système et leurs interactions principales avec le framework d'import.
...
\begin{figure}[H]
    ...
    \caption{Diagramme de classes du framework d'import}
