...
\begin{enumerate}
    ...
    \item \textbf{Développer une application d'interface} — Offrir aux consultants fonctionnels une application web (Axelor Import Studio) qui encapsule l'ensemble du processus : de l'upload des fichiers à la consultation des résultats d'import, en passant par l'interaction conversationnelle avec l'agent IA.
...
\begin{itemize}
    ...
    \item \textbf{Une application web} (Axelor Import Studio) — offrant une interface conversationnelle guidant le responsable d'intégration à travers le processus complet : upload des CSV, mapping interactif, validation du manifeste, génération et exécution des pipelines.
\end{itemize}
