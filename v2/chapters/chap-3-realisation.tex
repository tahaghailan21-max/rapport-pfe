...
\begin{itemize}
  ...
  \item \textbf{Incrément 5~:} Interface Axelor Mapper : application web FastAPI + React incluant un terminal PTY xterm.js relayé par WebSocket, permettant au consultant d'interroger l'agent IA depuis le navigateur.
