...
%% ──────────────────────────────────────────────────────────────
\subsection{Application Axelor Import Studio}

L'application Axelor Import Studio est l'interface web qui encapsule l'ensemble du processus d'import. Elle se compose d'un backend FastAPI (Python) et d'un frontend React avec un terminal embarqué (xterm.js). Les sous-sections suivantes décrivent l'architecture interne avant de présenter l'interface utilisateur.
...
\begin{table}[H]
  ...
  \begin{tabular}{p{3.5cm} p{9cm}}
    ...
    \bottomrule
  \end{tabular}
  \caption{Modules du backend Axelor Import Studio}
...
Ce chapitre a présenté l'environnement de développement et l'implémentation des quatre modules d'import (19 pipelines), des 3 skills IA, et de l'application Axelor Import Studio. Chaque module suit des patterns adaptés à sa complexité. Le chapitre suivant présente les résultats obtenus et la validation du système.
